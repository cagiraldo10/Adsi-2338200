Proceso ejercicio02Simples
	//2. La compañía de seguros de vida atlas se va a cambiar de domicilio y por lo tanto pone en venta suterreno pero no tiene 
	//una idea del valor del terreno, entonces solicita al departamento de sistemasque le desarrolle un algoritmo con la finalidad 
	//de que calcule e imprima el precio del terreno del cual se tiene los si
	//guientes datos: largo, ancho y precio por metro cuadrado, si el terreno tiene más de
