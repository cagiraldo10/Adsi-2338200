    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (contador <= n)
            {
                for (c = 1; c <= n; c++)
                {
                    Console.WriteLine("\nIngrese el valor de la primer venta del vendedor numero " + c);
                    _ = double.TryParse(Console.ReadLine(), out double venta1);
                    Console.WriteLine("\nIngrese el valor de la segunda venta del vendedor numero " + c);
                    _ = double.TryParse(Console.ReadLine(), out double venta2);
                    Console.WriteLine("\nIngrese el valor de la tercer venta del vendedor numero " + c);
